...
public class ComentthepostinOtheruser extends TestngBaseClass {
	...
	public void updatethepost() {
		...
		ExceptedstatusText = excelfile.getExcelData(FilePaths.HOME_MODULE_SHEET, 2, 1) + javautil.getradomNo(100);
		Exceptedstatusphoto = excelfile.getExcelData(FilePaths.HOME_MODULE_SHEET, 2, 2);
